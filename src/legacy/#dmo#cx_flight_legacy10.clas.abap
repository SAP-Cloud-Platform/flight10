CLASS /dmo/cx_flight_legacy10 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_10',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_10',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id10 OPTIONAL
        booking_id            TYPE /dmo/booking_id10 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id10 OPTIONAL
        agency_id             TYPE /dmo/agency_id10 OPTIONAL
        customer_id           TYPE /dmo/customer_id10 OPTIONAL
        carrier_id            TYPE /dmo/carrier10-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_10-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_10-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date10 OPTIONAL
        end_date              TYPE /dmo/end_date10 OPTIONAL
        booking_date          TYPE /dmo/booking_date10 OPTIONAL
        flight_date           TYPE /dmo/flight_date10 OPTIONAL
        status                TYPE /dmo/travel_status10 OPTIONAL
        currency_code         TYPE /dmo/currency_code10 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id10,
          mv_booking_id            TYPE /dmo/booking_id10,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id10,
          mv_agency_id             TYPE /dmo/agency_id10,
          mv_customer_id           TYPE /dmo/customer_id10,
          mv_carrier_id            TYPE /dmo/carrier10-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_10-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_10-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date10,
          mv_end_date              TYPE /dmo/end_date10,
          mv_booking_date          TYPE /dmo/booking_date10,
          mv_flight_date           TYPE /dmo/flight_date10,
          mv_status                TYPE /dmo/travel_status10,
          mv_currency_code         TYPE /dmo/currency_code10,
...
CLASS /dmo/cx_flight_legacy10 IMPLEMENTATION.
