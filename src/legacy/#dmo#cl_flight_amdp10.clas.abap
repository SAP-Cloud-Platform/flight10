CLASS /dmo/cl_flight_amdp10 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS convert_currency IMPORTING VALUE(iv_amount)               TYPE /dmo/total_price10
                                                  VALUE(iv_currency_code_source) TYPE /dmo/currency_code10
                                                  VALUE(iv_currency_code_target) TYPE /dmo/currency_code10
                                                  VALUE(iv_exchange_rate_date)   TYPE d
                                        EXPORTING VALUE(ev_amount)               TYPE /dmo/total_price10.
ENDCLASS.



CLASS /dmo/cl_flight_amdp10 IMPLEMENTATION.
