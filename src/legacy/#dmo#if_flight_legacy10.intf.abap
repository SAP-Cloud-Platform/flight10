...
INTERFACE /dmo/if_flight_legacy10
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL10
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel10     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING10
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking10    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_10
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_10 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT10
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight10 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id10.
  ...
  TYPES booking_id TYPE /dmo/booking_id10.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id10.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL10, /DMO/BOOKING10, /DMO/BOOK_SUP_10 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code10.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code10,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status10,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel10_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id10.
  INCLUDE TYPE /dmo/booking10_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id10.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id10.
  INCLUDE TYPE /dmo/book_sup_10_data.
