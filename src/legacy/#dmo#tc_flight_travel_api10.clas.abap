CLASS /dmo/tc_flight_travel_api10 DEFINITION
  PUBLIC
  ABSTRACT
  CREATE PUBLIC
  FOR TESTING
...
CLASS /dmo/tc_flight_travel_api10 IMPLEMENTATION.
  METHOD class_setup.
  ...
  METHOD cuerd_travel.
    ...
    DATA ls_travel_inx TYPE /dmo/if_flight_legacy10=>ts_travel_inx.
    DATA ls_travel     TYPE /dmo/travel10.
    ...
    " DB Check
    SELECT SINGLE agency_id, customer_id, description FROM /dmo/travel10 WHERE travel_id = @lv_travel_id INTO ( @DATA(lv_agency_id), @DATA(lv_customer_id), @DATA(lv_description) ).
    ...
    cl_abap_unit_assert=>assert_equals( act = ls_travel-status       exp = CONV /dmo/travel_status10( /dmo/if_flight_legacy10=>travel_status-new ) ).
    ...
    cl_abap_unit_assert=>assert_equals( act = ls_travel-status       exp = CONV /dmo/travel_status10( /dmo/if_flight_legacy10=>travel_status-booked ) ).
