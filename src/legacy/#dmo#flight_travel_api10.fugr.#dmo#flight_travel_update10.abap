...
"! @parameter es_travel              | Evaluated Travel Data like /DMO/TRAVEL10
"! @parameter et_booking             | Table of evaluated Bookings like /DMO/BOOKING10
"! @parameter et_booking_supplement  | Table of evaluated Booking Supplements like /DMO/BOOK_SUP_10
"! @parameter et_messages            | Table of occurred messages
"!
FUNCTION /DMO/FLIGHT_TRAVEL_UPDATE10.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
*"     REFERENCE(IS_TRAVEL) TYPE  /DMO/IF_FLIGHT_LEGACY10=>TS_TRAVEL_IN
*"     REFERENCE(IS_TRAVELX) TYPE  /DMO/IF_FLIGHT_LEGACY10=>TS_TRAVEL_INX
*"     REFERENCE(IT_BOOKING) TYPE  /DMO/IF_FLIGHT_LEGACY10=>TT_BOOKING_IN
*"       OPTIONAL
*"     REFERENCE(IT_BOOKINGX) TYPE
*"        /DMO/IF_FLIGHT_LEGACY10=>TT_BOOKING_INX OPTIONAL
*"     REFERENCE(IT_BOOKING_SUPPLEMENT) TYPE
*"        /DMO/IF_FLIGHT_LEGACY10=>TT_BOOKING_SUPPLEMENT_IN OPTIONAL
*"     REFERENCE(IT_BOOKING_SUPPLEMENTX) TYPE
*"        /DMO/IF_FLIGHT_LEGACY10=>TT_BOOKING_SUPPLEMENT_INX OPTIONAL
*"  EXPORTING
*"     REFERENCE(ES_TRAVEL) TYPE  /DMO/TRAVEL10
*"     REFERENCE(ET_BOOKING) TYPE  /DMO/IF_FLIGHT_LEGACY10=>TT_BOOKING
*"     REFERENCE(ET_BOOKING_SUPPLEMENT) TYPE
*"        /DMO/IF_FLIGHT_LEGACY10=>TT_BOOKING_SUPPLEMENT
*"     REFERENCE(ET_MESSAGES) TYPE  /DMO/IF_FLIGHT_LEGACY10=>TT_MESSAGE
*"----------------------------------------------------------------------
  CLEAR es_travel.
  CLEAR et_booking.
  ...
  /dmo/cl_flight_legacy10=>get_instance( )->update_travel( EXPORTING is_travel              = is_travel
  ...
  /dmo/cl_flight_legacy10=>get_instance( )->convert_messages( EXPORTING it_messages = lt_messages
