@AbapCatalog.sqlViewName: '/DMO/ICONNE_R10'
...
define view /DMO/I_Connection_R10
  as select from /dmo/connecti_10 as Connection

  association [1..*] to /DMO/I_Flight_R10 as _Flight  on  $projection.AirlineID    = _Flight.AirlineID
                                                    and $projection.ConnectionID = _Flight.ConnectionID
  association [1]    to /DMO/I_Carrier10  as _Airline on  $projection.AirlineID = _Airline.AirlineID

{
  ...
  key   Connection.connection_id    as ConnectionID,
        ...
        @Consumption.valueHelpDefinition: [{  entity: {   name: '/DMO/I_Airport10',
                              element:    'AirportID' } }]
        @Search.defaultSearchElement: true
