...
CLASS lcl_message_helper DEFINITION CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    TYPES tt_bookingsupplement_failed   TYPE TABLE FOR FAILED   /dmo/i_bookingsupplement_u10.
    TYPES tt_bookingsupplement_reported TYPE TABLE FOR REPORTED /dmo/i_bookingsupplement_u10.
    ...
    CLASS-METHODS handle_bookingsuppl_messages
      IMPORTING iv_cid                  TYPE string OPTIONAL
                ...
                iv_bookingsupplement_id TYPE /dmo/booking_supplement_id10 OPTIONAL
...
CLASS lhc_supplement DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  PRIVATE SECTION.
    TYPES:
        ...
        tt_bookingsupplement_update TYPE TABLE FOR UPDATE    /dmo/i_bookingsupplement_u10.
  ...
  METHOD update_bookingsupplement.
    ...
    LOOP AT it_bookingsupplement_update ASSIGNING FIELD-SYMBOL(<fs_bookingsupplement_update>).
      CALL FUNCTION '/DMO/FLIGHT_TRAVEL_UPDATE10'
        EXPORTING
          is_travel              = VALUE /dmo/if_flight_legacy10=>ts_travel_in( travel_id = <fs_bookingsupplement_update>-travelid )
          is_travelx             = VALUE /dmo/if_flight_legacy10=>ts_travel_inx( travel_id = <fs_bookingsupplement_update>-travelid )
          it_booking_supplement  = VALUE /dmo/if_flight_legacy10=>tt_booking_supplement_in( ( /dmo/cl_travel_auxiliary10=>map_bookingsupplemnt_cds_to_db( CORRESPONDING #( <fs_bookingsupplement_update> ) ) ) )
          it_booking_supplementx = VALUE /dmo/if_flight_legacy10=>tt_booking_supplement_inx( ( _fill_bookingsupplement_inx( <fs_bookingsupplement_update> ) ) )
        IMPORTING
...
**********************************************************************
  ...
  METHOD _fill_bookingsupplement_inx.
    ...
    rs_bookingsupplement_inx-action_code           = /dmo/if_flight_legacy10=>action_code-update.
...
**********************************************************************
  METHOD delete_bookingsupplement.
    ...
    LOOP AT it_bookingsupplement_delete INTO DATA(ls_bookingsupplement_delete).
      ...
      CALL FUNCTION '/DMO/FLIGHT_TRAVEL_UPDATE10'
        EXPORTING
          is_travel              = VALUE /dmo/if_flight_legacy10=>ts_travel_in( travel_id = ls_bookingsupplement_delete-travelid )
          is_travelx             = VALUE /dmo/if_flight_legacy10=>ts_travel_inx( travel_id = ls_bookingsupplement_delete-travelid )
          it_booking             = VALUE /dmo/if_flight_legacy10=>tt_booking_in( ( booking_id = ls_bookingsupplement_delete-bookingid ) )
          it_bookingx            = VALUE /dmo/if_flight_legacy10=>tt_booking_inx( ( booking_id  = ls_bookingsupplement_delete-bookingid ) )
          it_booking_supplement  = VALUE /dmo/if_flight_legacy10=>tt_booking_supplement_in( (  booking_supplement_id = ls_bookingsupplement_delete-bookingSupplementid
                                                                                             booking_id            = ls_bookingsupplement_delete-BookingID ) )
          it_booking_supplementx = VALUE /dmo/if_flight_legacy10=>tt_booking_supplement_inx( ( booking_supplement_id = ls_bookingsupplement_delete-bookingsupplementid
                                                                                             booking_id            = ls_bookingsupplement_delete-bookingid
