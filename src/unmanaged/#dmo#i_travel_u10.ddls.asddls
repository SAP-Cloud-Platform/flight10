@AbapCatalog.sqlViewName: '/DMO/ITRAV_U10'
...
define root view /DMO/I_Travel_U10
  as select from /dmo/travel10 as Travel -- the travel table is the data source for this view

  composition [0..*] of /DMO/I_Booking_U10 as _Booking

  association [0..1] to /DMO/I_Agency10       as _Agency    on $projection.AgencyID        = _Agency.AgencyID
  association [0..1] to /DMO/I_Customer10     as _Customer  on $projection.CustomerID      = _Customer.CustomerID
...

{
    ...
    @Consumption.valueHelpDefinition: [{ entity : {name: '/DMO/I_Agency10', element: 'AgencyID'  } }]
