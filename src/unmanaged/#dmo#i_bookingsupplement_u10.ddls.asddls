@AbapCatalog.sqlViewName: '/DMO/IBOOKSU_U10'
...
define view /DMO/I_BookingSupplement_U10
  as select from /dmo/book_sup_10 as BookingSupplement

  association        to parent /DMO/I_Booking_U10  as _Booking         on  $projection.TravelID  = _Booking.TravelID
                                                                     and $projection.BookingID = _Booking.BookingID

  association [1..1] to /DMO/I_Supplement10     as _Product  on $projection.SupplementID = _Product.SupplementID
  association [1..*] to /DMO/I_Supplement10Text10 as _SupplementText on  $projection.SupplementID = _SupplementText.SupplementID
{
  ...
  key BookingSupplement.booking_supplement_id  as BookingSupplementID,
      ...
      @Consumption.valueHelpDefinition: [{entity: {name: '/DMO/I_SUPPLEMENT10', element: 'SupplementID' },
