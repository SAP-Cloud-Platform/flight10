CLASS /dmo/cl_travel_auxiliary10 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*   Type definition for import parameters --------------------------
    TYPES tt_travel_create              TYPE TABLE FOR CREATE   /dmo/i_travel_u10.
    TYPES tt_travel_update              TYPE TABLE FOR UPDATE   /dmo/i_travel_u10.
    TYPES tt_travel_delete              TYPE TABLE FOR DELETE   /dmo/i_travel_u10.

    TYPES tt_travel_failed              TYPE TABLE FOR FAILED   /dmo/i_travel_u10.
    TYPES tt_travel_mapped              TYPE TABLE FOR MAPPED   /dmo/i_travel_u10.
    TYPES tt_travel_reported            TYPE TABLE FOR REPORTED /dmo/i_travel_u10.

    TYPES tt_booking_create             TYPE TABLE FOR CREATE    /dmo/i_booking_u10.
    TYPES tt_booking_update             TYPE TABLE FOR UPDATE    /dmo/i_booking_u10.
    TYPES tt_booking_delete             TYPE TABLE FOR DELETE    /dmo/i_booking_u10.

    TYPES tt_booking_failed             TYPE TABLE FOR FAILED    /dmo/i_booking_u10.
    TYPES tt_booking_mapped             TYPE TABLE FOR MAPPED    /dmo/i_booking_u10.
    ...
    TYPES tt_bookingsupplement_mapped   TYPE TABLE FOR MAPPED    /dmo/i_bookingsupplement_u10.
    ...
    CLASS-METHODS map_travel_cds_to_db
                            IMPORTING   is_i_travel_u       TYPE /dmo/i_travel_u10
                            RETURNING VALUE(rs_travel)      TYPE /dmo/if_flight_legacy10=>ts_travel_in.


    CLASS-METHODS map_travel_message
                            IMPORTING iv_cid                TYPE string OPTIONAL
                                      iv_travel_id          TYPE /dmo/travel_id10 OPTIONAL
                                      is_message            TYPE LINE OF /dmo/if_flight_legacy10=>tt_message
                            RETURNING VALUE(rs_report)      TYPE LINE OF tt_travel_reported.



    CLASS-METHODS map_booking_cds_to_db
                            IMPORTING is_i_booking          TYPE /dmo/i_booking_u10
                            RETURNING VALUE(rs_booking)     TYPE /dmo/if_flight_legacy10=>ts_booking_in.
    ...
    CLASS-METHODS map_bookingsupplemnt_cds_to_db
                            IMPORTING is_i_bookingsupplement      TYPE /dmo/i_bookingsupplement_u10
                            RETURNING VALUE(rs_bookingsupplement) TYPE /dmo/if_flight_legacy10=>ts_booking_supplement_in.
...
CLASS /dmo/cl_travel_auxiliary10 IMPLEMENTATION.
